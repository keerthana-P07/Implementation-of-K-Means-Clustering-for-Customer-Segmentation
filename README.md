...
3. Assign each data point to the nearest centroid using Euclidean distance and update the centroids by
...
## Output:
<img width="958" height="710" alt="image" src="https://github.com/user-attachments/assets/a6fad0f4-4295-452b-8012-5d2ca4f3463a" />
